...
class HGT(nn.Module):
    ...
    def __init__(self, in_dims, hidden_dim, num_heads, ntypes, etypes, predict_ntype, num_layers, dropout=0.2, use_norm=True):
        """HGT模型
    ...
    def forward(self, g, feats):
        ...
        for layer in self.layers:
            hs = layer(g, feats)  # {ntype: tensor(N_i, d_hid)}
